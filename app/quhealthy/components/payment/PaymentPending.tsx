...
import { Clock, RefreshCcw, HelpCircle, Mail, AlertCircle, Home } from "lucide-react";
        ...
        <Card className="bg-gray-800 border-gray-700 overflow-hidden">
          <CardHeader className="relative overflow-hidden p-0">
            ...
            <div className="relative p-6 text-center">
              ...
              <p className="text-gray-400">Estamos verificando tu pago</p>
            </div>
          </CardHeader>

          <CardContent className="p-6">
            <div className="mb-6"><Progress value={progress} className="bg-gray-700 h-2 [&>div]:bg-yellow-500" /></div>
            ...
            <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <Badge className="bg-yellow-500/20 text-yellow-400">${planPrice}/{planDuration}</Badge>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm text-gray-300"><Clock className="w-4 h-4 text-yellow-400" /><span>Tiempo estimado: {estimatedTime}</span></div>
                <div className="flex items-center gap-2 text-sm text-gray-300"><Mail className="w-4 h-4 text-yellow-400" /><span>Te notificaremos por correo cuando se complete</span></div>
              </div>
            </div>

            <div className="space-y-3">
              <Button className="w-full bg-yellow-500 hover:bg-yellow-600 text-black" onClick={() => window.location.reload()}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button variant="outline" className="text-gray-400 border-gray-700 hover:bg-gray-700" onClick={() => window.location.href = "/orders"}>
