...
export default function QuHealthyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      {/* Hero Section */}
      <header className="relative flex items-center justify-center min-h-screen px-8 text-center bg-gradient-to-b from-purple-600 to-blue-700">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          >
            <a
              href="/quhealthy/authentication/consumers/signup"
              className="bg-white text-purple-700 font-semibold py-4 px-8 rounded-lg hover:bg-gray-200 flex items-center justify-center gap-2"
            >
              Registrarse como Cliente <ArrowRight className="w-5 h-5" />
            </a>
            <a
              href="/quhealthy/authentication/providers/signup"
              className="bg-purple-800 text-white font-semibold py-4 px-8 rounded-lg hover:bg-purple-900 flex items-center justify-center gap-2"
            >
            ...
            {[
              {
                ...
                description:
                  "Nuestro sistema de IA analiza tus necesidades y preferencias para conectarte con los mejores proveedores de servicios.",
              },
              {
                icon: <Globe2 className="w-12 h-12 text-purple-500" />,
                title: "Conexión Internacional",
                description:
                  "Conectamos pacientes en USA con servicios de salud y belleza de alta calidad en México de manera segura.",
              },
              {
                icon: <ShieldCheck className="w-12 h-12 text-purple-500" />,
                title: "Pagos Seguros",
                description:
                  "Utiliza criptomonedas o métodos tradicionales para realizar pagos seguros y transparentes.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <Tabs defaultValue="consumer" className="w-full" onValueChange={setSelectedPlan}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {(selectedPlan === "consumer"
                ...
                <motion.div
                  key={index}
                  className="p-8 rounded-xl bg-gray-800 flex flex-col"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.2 }}
                >
                  ...
                  <p className="text-4xl font-bold mb-8 text-purple-500">{plan.price}</p>
                  ...
                  <a
                    ...
                    className="w-full bg-purple-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-purple-700 text-center"
                  >
                    Comenzar
                  </a>
                </motion.div>
      ...
      {/* Call to Action */}
      <footer className="py-16 px-8 bg-purple-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <a
              ...
              className="bg-white text-purple-700 font-semibold py-4 px-8 rounded-lg hover:bg-gray-200"
            >
              Registrarse como Cliente
            </a>
            <a
              href="/register/provider"
              className="bg-purple-800 text-white font-semibold py-4 px-8 rounded-lg hover:bg-purple-900"
            >
