  ...
  useEffect(() => {
    ...
    const fetchReceipt = async () => {
      ...
      try {
        ...
        toast.error(
          "ERROR: NO FUE POSIBLE RECUPERAR EL REGISTRO DE LA TRANSACCIÓN.",
        );
      } finally {
        setIsLoading(false);
      }
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col items-center justify-center p-6 text-center transition-colors duration-300">
        ...
        <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500 max-w-sm mx-auto mb-8">
          No encontramos los detalles de esta sesión. Revisa tu conexión o
          vuelve al panel. <br />
          ID:{" "}
          <span className="font-mono text-[9px] break-all bg-gray-100 dark:bg-gray-900 px-1">
            {sessionId}
          </span>
        </p>
        <Button
        ...
        >
          <div className="text-center mb-12 flex flex-col items-center">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500 max-w-md mx-auto">
              Tu compra se procesó correctamente. Enviamos el recibo a tu correo
              electrónico.
            </p>
          </div>
            ...
            <div className="p-8 space-y-10">
              ...
              <div>
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-black dark:text-white flex items-center gap-3 mb-6 border-b border-gray-200 dark:border-gray-800 pb-4">
                  <Package className="w-4 h-4" strokeWidth={1.5} /> Resumen de
                  tu Compra
                </h3>
                ...
                <div className="divide-y divide-gray-200 dark:divide-gray-800">
                  {receipt.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex justify-between items-start py-4 hover:bg-gray-50 dark:hover:bg-[#050505] transition-colors -mx-4 px-4"
                    >
