...
export default function SupportPage() {
  ...
  const handleEmailSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res.success) {
      toast.success(
        "¡Solicitud enviada exitosamente! Nuestro equipo te contactará pronto.",
      );
    ...
    <div className="max-w-4xl space-y-12">
      ...
      <div className="border-b border-gray-200 dark:border-gray-800 pb-6">
        ...
        <p className="text-gray-500 font-light mt-3 max-w-2xl text-sm leading-relaxed">
          Estamos aquí para ayudarte. Selecciona el canal de comunicación de tu
          preferencia para resolver cualquier duda o inconveniente técnico.
        </p>
      </div>
