        ...
        <div className="bg-white dark:bg-[#0a0a0a] border border-black dark:border-white shadow-[8px_8px_0_0_#000] dark:shadow-[8px_8px_0_0_#fff] flex flex-col">
          <div className="p-8 md:p-12 flex flex-col items-center text-center">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500 max-w-md mx-auto leading-relaxed mb-10">
              LA TRANSACCIÓN HA SIDO VERIFICADA EN LA RED. EL CAPITAL SE
              ENCUENTRA DISPONIBLE EN SU BÓVEDA FINANCIERA PARA FUTURAS
              OPERACIONES.
            </p>
            ...
            <div className="w-full space-y-4">
              ...
              >
                ...
                <ArrowRight
                  className="w-4 h-4 text-gray-400 group-hover:text-white dark:group-hover:text-black transition-colors"
                  strokeWidth={1.5}
                />
              </Button>
