...
// ── Tarjeta de Proveedor Arquitectónica ──
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col bg-white dark:bg-[#0a0a0a]">
        ...
        {/* CTA BUTTON (Usa el color del proveedor como acento arquitectónico) */}
        <Button
          onClick={(e) => {
            e.stopPropagation();
...
const DiscoverMapContent = () => {
  ...
  if (isFetchingProviders) {
    return (
      <div className="h-screen w-full flex items-center justify-center bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
  ...
  return (
    <div className="relative w-full h-[calc(100vh-64px)] bg-gray-100 dark:bg-[#111] overflow-hidden selection:bg-gray-200 dark:selection:bg-white/20 font-sans transition-colors">
...
export default function DiscoverPageWrapper() {
  ...
  if (loadError) {
    return (
      <div className="h-screen w-full flex items-center justify-center bg-white dark:bg-[#0a0a0a] text-red-500 font-bold uppercase tracking-widest text-xs p-6 text-center">
  ...
  if (!isLoaded) {
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-white dark:bg-[#0a0a0a] transition-colors">
        <QhSpinner size="lg" />
