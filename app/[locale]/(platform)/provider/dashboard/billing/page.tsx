...
function StripeConnectCardSkeleton() {
  return (
    <div className="border border-black dark:border-white bg-white dark:bg-[#0a0a0a] p-6 md:p-8 rounded-none transition-colors">
      <div className="flex items-start gap-5 animate-pulse">
        <div className="h-14 w-14 border border-black/20 dark:border-white/20 bg-gray-50 dark:bg-[#050505] shrink-0" />
    ...
    <div className="space-y-12 pb-16 font-sans selection:bg-gray-200 dark:selection:bg-white/20 transition-colors duration-300 bg-gray-50 dark:bg-[#050505] min-h-screen pt-8">
      ...
      <div className="max-w-6xl mx-auto space-y-12 px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-black/20 dark:border-white/20">
          ...
          <div>
            <span className="border border-black dark:border-white bg-black text-white dark:bg-white dark:text-black px-4 py-2 text-[9px] font-bold uppercase tracking-widest flex items-center gap-2 w-fit rounded-none">
              <Sparkles className="w-3 h-3" strokeWidth={1.5} /> OPERATIVA FINANCIERA
            </span>
          </div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section>
            <div className="mb-6 flex items-center gap-4 pb-4 border-b border-black/20 dark:border-white/20">
              <div className="w-10 h-10 border border-black/20 dark:border-white/20 bg-white dark:bg-[#0a0a0a] flex items-center justify-center shrink-0">
                <Building2 className="w-4 h-4 text-black dark:text-white" strokeWidth={1.5} />
              </div>
              <div>
