...
export default function InventoryPage() {
 ...
 toast.success(`Inventario actualizado: ${adjustingItem.name}`, { theme: 'colored' });
 ...
 <p className="text-sm font-semibold text-gray-500 animate-pulse">Sincronizando inventario...</p>
 </div>
 );
 }
 ...
 <Boxes className="w-6 h-6 text-emerald-600 dark:text-emerald-400" strokeWidth={2} />
 </div>
 <div>
 ...
 <ScanLine className="w-4 h-4 text-emerald-600 dark:text-emerald-400" strokeWidth={2} />
 <span className="text-xs font-bold text-gray-700 dark:text-gray-300">Óptica / Escáner</span>
 </div>
 ...
 <div className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-gray-800 flex flex-col rounded-3xl shadow-sm overflow-hidden">
 <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-[#050505] flex items-center gap-2">
 <Filter className="w-4 h-4 text-emerald-600 dark:text-emerald-400" strokeWidth={2} />
 <span className="text-xs font-bold text-gray-700 dark:text-gray-300">Parámetros de Búsqueda</span>
 </div>
 ...
 filterType === 'ALL' ? "bg-white dark:bg-[#111] text-emerald-600 border border-gray-200 dark:border-gray-700" : "bg-transparent text-gray-500 hover:bg-gray-100 dark:hover:bg-[#111]"
 )}
 >
 Todos
 </button>
 ...
 filterType === 'PRODUCT' ? "bg-white dark:bg-[#111] text-emerald-600 border border-gray-200 dark:border-gray-700" : "bg-transparent text-gray-500 hover:bg-gray-100 dark:hover:bg-[#111]"
 )}
 >
 ...
 className={cn(
 "flex-1 h-10 flex items-center justify-center gap-2 rounded-lg transition-colors text-xs font-bold shadow-sm",
 filterType === 'SUPPLY' ? "bg-white dark:bg-[#111] text-emerald-600 border border-gray-200 dark:border-gray-700" : "bg-transparent text-gray-500 hover:bg-gray-100 dark:hover:bg-[#111]"
 )}
 >
 <ShieldCheck className="w-3.5 h-3.5" strokeWidth={2} /> Insumos
 </button>
 </div>
 </div>
 ...
 <PackageSearch className="w-4 h-4 text-emerald-600 dark:text-emerald-400" strokeWidth={2} /> 
 Kardex de Artículos
 </h2>
 ...
 return (
 <div key={item.id} className="p-6 hover:bg-gray-50 dark:hover:bg-[#111] transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-6 cursor-pointer group">
 ...
 {item.type === 'PRODUCT' ? <Pill className="w-5 h-5 text-gray-500 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors" strokeWidth={2} /> : <ShieldCheck className="w-5 h-5 text-gray-500 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors" strokeWidth={2} />}
 </div>
 ...
 <p className="text-xs font-semibold text-gray-500 mb-1.5">Disponible</p>
 <span className={cn(
 ...
 <button onClick={() => setAdjustingItem(null)} className="w-10 h-10 rounded-xl flex items-center justify-center bg-gray-50 dark:bg-[#111] hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors shrink-0">
 ...
 Establezca el ajuste para <span className="text-gray-900 dark:text-white font-bold">{adjustingItem?.name}</span>. Utilice valores positivos para entradas y negativos para mermas o uso interno.
 </DialogDescription>
 </div>
 ...
 <span className="text-xs font-semibold text-gray-500 mb-2">Stock Registrado</span>
 ...
 <span className="text-xs font-semibold text-gray-500 mb-2">Diferencial (+ / -)</span>
 ...
 Proyección Final: <span className="text-emerald-600 dark:text-emerald-400 font-bold ml-1">{adjustingItem ? adjustingItem.stockQuantity + (typeof adjustmentValue === 'number' ? adjustmentValue : 0) : 0}</span>
 </p>
 </div>
