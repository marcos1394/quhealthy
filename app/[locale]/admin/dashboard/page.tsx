...
export default function AdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "economics" | "operations" | "health" | "transactions"
  >("economics");
  ...
  useEffect(() => {
    ...
    const roleCookie = cookies.find((c) =>
      c.trim().startsWith("__Secure-userRole="),
    );
      ...
      <main className="max-w-7xl mx-auto p-6 lg:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Visibilidad crítica de negocio, operaciones y nube.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm border-l-4 border-l-blue-500">
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mt-1">
                    {formatCurrency(economics.totalSubscriptionsRevenue)}
                  </h3>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm border-l-4 border-l-purple-500">
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mt-1">
                    {formatCurrency(economics.totalCommissionsRevenue)}
                  </h3>
                  <p className="text-xs text-purple-600 mt-2">
                    Citas, Cursos, Productos
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm border-l-4 border-l-orange-500">
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mt-1">
                    {formatCurrency(economics.stripeFees)}
                  </h3>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm border-l-4 border-l-rose-500">
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mt-1">
                    {formatCurrency(economics.cloudCosts)}
                  </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex gap-4 items-center justify-center flex-wrap">
                    ...
                    <div className="text-center p-4 bg-slate-50 rounded-2xl flex-1 min-w-[120px]">
                      ...
                      <p className="text-xl font-bold text-rose-500 mt-1">
                        {formatCurrency(economics.costPerUser)}
                      </p>
                    </div>
                    <div className="text-xl text-slate-300">=</div>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm overflow-hidden">
                  ...
                  {economics.topProviders &&
                  economics.topProviders.length > 0 ? (
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm mt-6">
                <h3 className="text-lg font-bold text-slate-900 mb-6">
                  Desglose de Ventas por Tipo (Marketplace)
                </h3>
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-slate-500">
                            {sale.volumeCount} items vendidos
                          </p>
                        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
                  ...
                  <h3 className="text-3xl font-bold text-slate-900">
                    {dashboard.activeProvidersThisMonth}
                  </h3>
                </div>
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-slate-500 text-sm font-medium">
                      Nuevos Médicos (Onboarding)
                    </p>
                    <Users className="w-5 h-5 text-violet-500" />
                  </div>
                  <h3 className="text-3xl font-bold text-slate-900">
                    {dashboard.newProvidersThisMonth}
                  </h3>
                </div>
              </div>
                  ...
                  <ResponsiveContainer width="100%" height={250}>
                    <BarChart
                      ...
                      data={[
                        {
                          name: "Completadas",
                          cantidad: dashboard.completedAppointmentsThisMonth,
                          color: "#10b981",
                        },
                        {
                          name: "Canceladas",
                          cantidad: dashboard.cancelledAppointmentsThisMonth,
                          color: "#f43f5e",
                        },
                        {
                          name: "No-Show",
                          cantidad: dashboard.noShowAppointmentsThisMonth,
                          color: "#f59e0b",
                        },
                      ]}
                    ...
                    >
                      ...
                      <Bar dataKey="cantidad" radius={[0, 4, 4, 0]}>
                        {[0, 1, 2].map((entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                            fill={["#10b981", "#f43f5e", "#f59e0b"][index]}
                          />
                        ))}
                      </Bar>
                    </BarChart>
            ...
            <div className="space-y-6">
              <div className="bg-slate-900 text-white border border-slate-800 rounded-3xl p-8 shadow-xl">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    ...
                    <p className="text-slate-400 mt-1">
                      Monitoreo activo usando Spring Boot Actuator y Grafana
                    </p>
                  </div>
                  <a
                ...
                <div className="mt-6 p-4 bg-rose-500/10 border border-rose-500/20 rounded-xl flex gap-3 text-rose-400">
                  ...
                  <p className="text-sm">
                    <strong>Nota:</strong> Los estados mostrados aquí son
                    simulados en la capa del Admin Master UI. Para ver latencias
                    reales, colas de RabbitMQ, uso de CPU y logs de errores 500,
                    ingresa al panel oficial de Grafana en GCP.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex justify-between items-center mb-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                      Reporte exacto extraído de los "Balance Transactions" de
                      Stripe. Fuente absoluta de verdad.
                    </p>
                  </div>
                  <button
                    ...
                    <table className="w-full text-left text-sm text-slate-600">
                      <thead className="text-xs uppercase bg-slate-50 text-slate-500 border-b border-slate-200">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-right text-indigo-600 rounded-tr-xl">
                            Ganancia Doctor
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        {transactions.length === 0 && (
                          <tr>
                            <td
                              colSpan={6}
                              className="px-4 py-8 text-center text-slate-400 bg-slate-50 rounded-b-xl"
                            >
                              No hay transacciones registradas en los últimos 30
                              días.
                            </td>
                          </tr>
                        )}
