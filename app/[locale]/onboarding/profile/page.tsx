                      ...
                      >
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-200 dark:border-gray-800">
                            <button
                              ...
                              className={cn(
                                "p-8 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-800 transition-colors text-left group",
                                formData.personType === "FISICA"
                                  ? "bg-black text-white dark:bg-white dark:text-black"
                                  : "bg-gray-50 dark:bg-[#050505] hover:bg-gray-100 dark:hover:bg-[#0a0a0a]",
                              )}
                            >
                              <div
                                className={cn(
                                  "w-12 h-12 border flex items-center justify-center mb-6",
                                  formData.personType === "FISICA"
                                    ? "border-white dark:border-black"
                              ...
                              >
                                Persona Física. Ofrezco mis servicios de manera
                                individual.
                              </p>
                            </button>
                            ...
                            <button
                              ...
                              className={cn(
                                "p-8 transition-colors text-left group",
                            ...
                            >
                              ...
                              >
                                Persona Moral. Represento a una clínica,
                                consultorio o equipo.
                              </p>
                            </button>
                          </div>
                        </div>
                        ...
                        {formData.personType && (
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            className="space-y-6 pt-12 border-t border-gray-200 dark:border-gray-800"
                          >
                            <h3 className="text-xl font-semibold text-black dark:text-white tracking-tight">
                      ...
                      >
                        ...
                        <div className="space-y-3 relative z-20">
                          <Label className="text-[10px] font-bold uppercase tracking-widest text-black dark:text-white flex items-center justify-between">
                            ...
                            <span className="text-[9px] text-gray-400 font-light lowercase tracking-normal">
                          ...
                          <div className="relative group">
                            ...
                            />
                            {isSearching && (
                              <Loader2 className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 animate-spin text-black dark:text-white" />
                            )}
                          </div>
                              ...
                              >
                                {predictions.map((p: any) => (
                                  ...
                                  >
                                    ...
                                    />
                                    <div>
                                      <p className="text-xs font-bold uppercase tracking-widest text-black dark:text-white mb-0.5">
                        ...
                        {selectedPlaceInfo && (
                          ...
                          >
                            <div className="p-6 space-y-4">
                              <div className="flex justify-between items-start">
                                ...
                                <div className="flex items-center gap-1.5 border border-gray-300 dark:border-gray-700 px-2 py-0.5 bg-white dark:bg-black">
                                  ...
                                  <span className="font-bold text-[10px] text-black dark:text-white">
                              ...
                              <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                  ...
                                  <p className="text-[10px] text-gray-500 flex items-center gap-1 font-light">
                            ...
                            <div className="bg-white dark:bg-black border-t border-black dark:border-white p-3 flex justify-between items-center">
                              ...
                              <button
                                type="button"
                                className="text-[9px] font-bold uppercase tracking-widest text-gray-400 hover:text-black dark:hover:text-white transition-colors"
                ...
                >
                  ...
                  {isStep3Valid && (
                    <motion.div
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="p-4 bg-gray-50 dark:bg-[#050505] border border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
                    >
                      ...
                      <button
                        ...
                        className={cn(
                          "h-10 px-6 text-[9px] font-bold uppercase tracking-widest transition-all",
                          isFormValid
              ...
              <div>
                {activeStep < 3 ? (
                  <button
                    ...
                    className={cn(
                      "group h-14 px-8 text-[10px] font-bold uppercase tracking-widest transition-all flex items-center justify-center",
                      (activeStep === 1 && isStep1Valid) ||
                        (activeStep === 2 && isStep2Valid)
                        ? "bg-black text-white dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200"
