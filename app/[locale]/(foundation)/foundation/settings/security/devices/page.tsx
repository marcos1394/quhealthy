...
import { SharedDevicesManager } from "@/components/shared/settings/security/SharedDevicesManager";

export default function FoundationDevicesPage() {
      ...
      <div className="flex items-center gap-4 pb-6 border-b border-gray-100 dark:border-gray-800">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900 dark:text-white leading-tight">
            {t("options.devices.title")}
          </h1>
          <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mt-0.5">
            {t("options.devices.desc")}
          </p>
        </div>
      </div>
      <SharedDevicesManager />
    </div>
  );
}
