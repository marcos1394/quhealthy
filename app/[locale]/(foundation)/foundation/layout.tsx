...
export const metadata: Metadata = {
  title: "Portal Fundación | QuHealthy",
  description: "Centro de gestión institucional para fundaciones y programas asistenciales de salud",
  robots: {
    index: false,
    follow: false,
  },
...
export default function FoundationLayout({
  ...
  return (
    <AuthProvider>
      <div className="flex flex-col md:flex-row h-screen w-full bg-gray-50/50 dark:bg-[#050505] text-gray-900 dark:text-white font-sans antialiased selection:bg-rose-500/20 overflow-hidden transition-colors duration-500">
        {/* Navbar (Mobile only) */}
        <MobileNavbar />
