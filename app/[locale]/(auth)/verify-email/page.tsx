            ...
            {status === "loading" && (
              ...
              >
                <motion.div
                  ...
                  className="mx-auto w-16 h-16 bg-gray-100 dark:bg-[#111111] rounded-none flex items-center justify-center"
                >
                  <Mail
                ...
                <div className="space-y-2 max-w-xs mx-auto">
                  <div className="flex justify-between text-xs font-medium">
                    <span className="text-gray-500">{t("verifying")}</span>
                ...
                <div className="bg-gray-100 dark:bg-[#111111] border border-gray-200 dark:border-gray-800 rounded-none p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left text-sm text-black dark:text-white space-y-1">
                      <p>
                        Si no lo encuentras en tu bandeja de entrada principal,
            ...
            {status === "error" && (
              ...
              >
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-none p-4 text-left">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm space-y-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-xs text-red-600 dark:text-red-300/80">
                        <li>{t("cause_1")}</li>
                        <li>{t("cause_2")}</li>
                        <li>{t("cause_3")}</li>
                      </ul>
                ...
                <div className="space-y-3">
                  <Button
                    onClick={() => router.push("/login")}
                    className="w-full h-12 bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black dark:hover:bg-gray-100 rounded-none shadow-none font-semibold"
                  >
                    {t("go_to_login")}
                  </Button>
                  <Button
