  ...
  const trustPillars = [
    {
      ...
      description: t("trust.t1_desc"),
    },
    {
      icon: Earth,
      title: t("trust.t2_title"),
      description: t("trust.t2_desc"),
    },
    {
      icon: BadgeCheck,
      title: t("trust.t3_title"),
      description: t("trust.t3_desc"),
    },
  ];
          ...
          >
            {values.map((val, idx) => {
              ...
              return (
                ...
                >
                  <Icon
                    className="w-8 h-8 text-black dark:text-white mb-8 opacity-50 group-hover:opacity-100 transition-opacity duration-300"
                    strokeWidth={1.5}
                  />
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-6xl">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="group">
              ...
              <h3 className="text-2xl font-semibold text-black dark:text-white mb-2">
                {t("team_partner_fausto_name")}
              </h3>
              <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">
                {t("team_partner_fausto_role")}
              </p>
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-light text-sm">
                {t("team_partner_fausto_bio")}
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="group">
              ...
              <h3 className="text-2xl font-semibold text-black dark:text-white mb-2">
                {t("team_partner_pedro_name")}
              </h3>
              <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">
                {t("team_partner_pedro_role")}
              </p>
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-light text-sm">
                {t("team_partner_pedro_bio")}
              </p>
            </motion.div>
          </motion.div>
        </div>
