...
export default function QuScoreMethodologyPage() {
  ...
  const getPillarIcon = (key: string) => {
    switch (key) {
      ...
      case "P2":
        return <Star className="w-5 h-5" strokeWidth={1.5} />;
      case "P3":
        return <UserCheck className="w-5 h-5" strokeWidth={1.5} />;
      case "P4":
        return <Activity className="w-5 h-5" strokeWidth={1.5} />;
      case "P5":
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex items-center justify-center">
        <p className="text-[10px] font-bold uppercase tracking-widest text-red-500">
          ERROR DE RECUPERACIÓN DE DATOS.
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border border-black dark:border-white shadow-[8px_8px_0_0_#000] dark:shadow-[8px_8px_0_0_#fff] divide-y md:divide-y-0 md:divide-x divide-black dark:divide-white">
          ...
          <div className="p-6 flex items-center gap-4">
            ...
            <span className="text-[9px] font-bold uppercase tracking-widest text-black dark:text-white">
              {new Date(methodology.lastReviewedAt).toLocaleDateString()}
            </span>
          </div>
          <div className="p-6 flex items-center gap-4">
            <span className="text-[9px] font-bold uppercase tracking-widest text-gray-500">
            ...
            <a
              ...
              className="text-[9px] font-bold uppercase tracking-widest text-black dark:text-white underline"
            >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <div className="space-y-4 pt-6 border-t border-black dark:border-white group-hover:border-white dark:group-hover:border-black">
                    {pillar.criteria.map((crit, cIdx) => (
                      <div
                        key={cIdx}
                        className="flex items-start gap-3 text-[9px] font-bold uppercase tracking-widest text-gray-700 group-hover:text-gray-300 dark:text-gray-300 dark:group-hover:text-gray-700"
                      >
                        <CheckCircle2
        ...
        <div>
          ...
          <div className="border border-black dark:border-white shadow-[8px_8px_0_0_#000] dark:shadow-[8px_8px_0_0_#fff] flex flex-col">
            {methodology.scoreBands.map((band, idx) => (
              <div
                key={idx}
                className={`p-8 flex flex-col sm:flex-row items-start sm:items-center gap-8 ${idx !== methodology.scoreBands.length - 1 ? "border-b border-black dark:border-white" : ""} bg-white dark:bg-[#0a0a0a]`}
              >
        ...
        <div className="border border-black dark:border-white bg-black text-white dark:bg-white dark:text-black p-8 shadow-[8px_8px_0_0_#000] dark:shadow-[8px_8px_0_0_#fff] flex flex-col md:flex-row items-start gap-8">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-300 dark:text-gray-600 leading-relaxed">
              EL QUSCORE ES UN ALGORITMO ESTRICTAMENTE ORGÁNICO Y ÉTICO.
              CUALQUIER ENTIDAD QUE INVIERTA EN PROMOCIÓN APARECERÁ MARCADA CON
              LA ETIQUETA "PATROCINADO" DE FORMA INDEPENDIENTE. <br />
              <br />
              <span className="text-white dark:text-black border-b border-white dark:border-black">
                NINGÚN PAGO O PATROCINIO PUEDE ALTERAR LA CALIFICACIÓN DEL
                QUSCORE NI INFLUIR EN EL RANKING ORGÁNICO DE RESULTADOS.
              </span>
            </p>
          </div>
        </div>
