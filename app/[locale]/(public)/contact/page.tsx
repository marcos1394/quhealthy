          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            >
              ...
              <div className="space-y-10 border-t border-gray-200 dark:border-white/10 pt-10">
                <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-black dark:text-white uppercase tracking-widest mb-2">
                      Correo Electrónico
                    </h3>
                    <a
                      href="mailto:founders@quhealthy.org"
                      className="text-gray-600 dark:text-gray-300 font-light text-lg hover:text-black dark:hover:text-white transition-colors border-b border-transparent hover:border-black dark:hover:border-white pb-0.5"
                    >
            ...
            >
              <motion.h2
                ...
                className="text-2xl font-semibold text-black dark:text-white mb-10"
              >
                {t("form_title")}
              </motion.h2>
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <motion.div variants={itemVariants} className="relative group">
                  ...
                  <select
                    name="topic"
                    className="w-full bg-transparent border-b border-gray-300 dark:border-gray-800 py-3 text-black dark:text-white font-light focus:outline-none focus:border-black dark:focus:border-white transition-colors appearance-none cursor-pointer"
                  >
                    <option className="text-black">
                      {t("form.topics.support")}
                    </option>
                    <option className="text-black">
                      {t("form.topics.billing")}
                    </option>
                    <option className="text-black">
                      {t("form.topics.careers")}
                    </option>
                    <option className="text-black">
                      {t("form.topics.other")}
                    </option>
