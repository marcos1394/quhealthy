            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 items-start">
                    ...
                    <StaggerContainer className="lg:col-span-3 bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-800 transition-colors duration-300">
                        ...
                        <div className="mb-10 p-6 bg-medical-50 dark:bg-medical-900/20 border border-medical-100 dark:border-medical-800/50 rounded-2xl flex items-start space-x-4">
                            <Info className="h-6 w-6 text-medical-600 dark:text-medical-400 flex-shrink-0 mt-1" />
                            <div>
                                <h4 className="text-lg font-bold text-slate-900 dark:text-white mb-2">En pocas palabras (In Plain English)</h4>
                                <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                                    Estos términos rigen el uso de nuestra plataforma. Básicamente: no hagas mal uso del servicio, respeta los derechos de terceros, y entiende que QuHealthy facilita conexiones pero no presta atención médica directa. Tu uso continuo implica aceptación.
                                </p>
                            </div>
                        </div>
                        ...
                        <StaggerItem className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed mb-8">
                            <p>
                                Los presentes Términos y Condiciones regulan el uso de la
