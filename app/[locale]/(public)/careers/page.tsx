          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            {benefits.map((benefit, idx) => {
              ...
              return (
                ...
                >
                  <Icon
                    className="w-6 h-6 text-black dark:text-white mb-6"
                    strokeWidth={1.5}
                  />
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-5xl">
          ...
          <div className="border-t border-black dark:border-white">
            ...
            {!isLoading &&
              ...
              (!jobOpenings || jobOpenings.length === 0) && (
                <div className="py-16 text-center">
                  <Briefcase
                    className="w-8 h-8 text-gray-300 dark:text-gray-700 mx-auto mb-4"
                    strokeWidth={1}
                  />
                  <h3 className="text-lg font-semibold text-black dark:text-white mb-2">
                    {t("empty_title")}
          ...
          <div className="mt-24 border border-black dark:border-white p-10 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 font-light max-w-xl">
                {t("open_app_desc")}
              </p>
            </div>
            <Button
