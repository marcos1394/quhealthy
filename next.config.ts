...
const nextConfig = {
    ...
    const cspHeader = `
        ...
        img-src 'self' data: https://*.stripe.com https://files.stripe.com https://xqejlzevtuknggchvyfa.supabase.co https://maps.gstatic.com https://maps.googleapis.com https://places.googleapis.com;
