    ...
    () => [
      {
        ...
        icon: Smartphone,
        link: "/patient/dashboard/settings/security/2fa",
      ...
      },
      {
        ...
        icon: Lock,
        link: "/patient/dashboard/settings/security/password",
        iconBg: "bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 border-emerald-100 dark:border-emerald-900/30",
        hoverBorder: "hover:border-emerald-500/30",
        isDanger: false,
      },
      {
        ...
        icon: Bell,
        link: "/patient/dashboard/settings/security/alerts",
      ...
      },
      {
        ...
        icon: Laptop,
        link: "/patient/dashboard/settings/security/devices",
      ...
      },
      {
        ...
        icon: Activity,
        link: "/patient/dashboard/settings/security/activity",
      ...
      },
      {
        ...
        icon: UserX,
        link: "/patient/dashboard/settings/security/delete-account",
