  ...
  const socialProviders = [
    {
      ...
      bgColor:
        "bg-white dark:bg-[#0a0a0a] border-gray-200 dark:border-gray-800 text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800",
      onClick: () => googleLogin(),
    },
    {
      id: "apple",
      ...
      bgColor:
        "bg-gray-100 dark:bg-[#050505] border-gray-200 dark:border-gray-800 text-gray-400 dark:text-gray-600",
      ...
      {socialProviders.map((provider, index) => (
        ...
        >
          <button
            ...
            title={provider.disabled ? t("apple_tooltip") : undefined}
            className={cn(
              "w-full h-11 relative flex items-center justify-center gap-2.5 transition-all duration-200 shadow-xs border rounded-xl text-xs font-bold",
              provider.bgColor,
              provider.disabled
