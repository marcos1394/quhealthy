...
export default function NutritionOnboarding({ initialData, onSubmit, isLoading }: Props) {
  ...
  const handleChange = (field: keyof NutritionProfileRequest, value: string | number) => {
  ...
  return (
    <div className="bg-white dark:bg-[#050505] rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 p-8 max-w-2xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-black dark:text-white mb-2">QuHealthy Food Vision</h2>
        <p className="text-gray-500 text-sm">
          Completa tu perfil para que nuestra IA calcule tus requerimientos calóricos exactos.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <select 
            ...
            className="w-full bg-gray-50 dark:bg-[#111] border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-3 text-black dark:text-white"
          >
        ...
        <div>
          ...
          >
            ...
            <option value="VERY_ACTIVE">Muy Activo (Ejercicio intenso todos los días)</option>
          </select>
        </div>
