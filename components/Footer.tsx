  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: t('columns.platform.links.foundations'), href: "/foundations" },
        { name: t('columns.platform.links.suppliers'), href: "/suppliers" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: t('columns.legal.links.returns', { defaultValue: "Devoluciones y Garantía" }), href: "/returns" },
        ...
        <div className="mt-16 pt-8 border-t border-gray-100 dark:border-gray-800/80">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs font-semibold text-gray-400">
              ...
              <Link href="/returns" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
