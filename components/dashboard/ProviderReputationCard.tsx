...
export function ProviderReputationCard() {
  ...
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-gray-800 min-h-[120px] flex flex-col items-center justify-center gap-3 transition-colors rounded-3xl shadow-sm p-8 font-sans">
  ...
  if (
    ...
    return (
      <div className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-gray-800 min-h-[120px] flex flex-col items-center justify-center p-8 text-center transition-colors rounded-3xl shadow-sm font-sans space-y-3">
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-gray-800 flex flex-col transition-colors rounded-3xl shadow-sm font-sans">
      {/* Header del Card */}
      <button
        type="button"
        onClick={() => setIsCardExpanded(!isCardExpanded)}
        className={cn(
          "w-full text-left p-6 sm:p-8 bg-gray-50/60 dark:bg-[#050505] hover:bg-gray-100/50 dark:hover:bg-[#111] transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0 focus:outline-none focus:ring-2 focus:ring-emerald-500/20",
          isCardExpanded ? "rounded-t-3xl border-b border-gray-100 dark:border-gray-800" : "rounded-3xl"
        )}
      >
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col md:items-end gap-1">
            ...
            <p className="text-[11px] font-mono font-medium text-gray-400 pt-0.5 text-right">
              {t("updated_at", {
                date: new Date(myActionableScore.lastCalculatedAt).toLocaleDateString(),
              })}
            </p>
          </div>
          <div className="w-8 h-8 rounded-full bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 flex items-center justify-center shrink-0 shadow-sm text-gray-500">
            {isCardExpanded ? (
      ...
      <AnimatePresence initial={false}>
        {isCardExpanded && (
          ...
          >
            <div className="flex-1 flex flex-col bg-white dark:bg-[#0a0a0a] rounded-b-3xl">
