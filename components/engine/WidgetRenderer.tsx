    ...
    switch (widget.type) {
      ...
      default:
        return (
          <div
            key={widget.id}
            className="p-4 rounded-2xl bg-amber-50/60 dark:bg-amber-950/20 border border-amber-200/60 dark:border-amber-900/40 text-amber-800 dark:text-amber-300 flex items-start gap-3 text-xs font-semibold shadow-2xs font-sans w-full max-w-md min-w-0"
          >
            ...
            <div className="space-y-0.5 min-w-0">
              ...
              <p className="text-[11px] font-medium text-amber-700/80 dark:text-amber-400/80">
                Tipo de widget no reconocido: <code className="font-mono bg-amber-100/50 dark:bg-amber-900/40 px-1.5 py-0.5 rounded-md break-all">{widget.type}</code>
              </p>
            </div>
          </div>
        );
