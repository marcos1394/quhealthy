...
export const AiConsentModal: React.FC<AiConsentModalProps> = ({ onSubmit, isSubmitting }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col justify-center h-full min-h-[500px]">
      <div className="bg-white dark:bg-[#0a0a0a] border border-black/20 dark:border-white/20 p-8 md:p-10 relative overflow-hidden group">
