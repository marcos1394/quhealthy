      ...
      <ScrollArea className="flex-1 max-h-[350px]">
        <div className="p-4 space-y-3">
          {appointments.map((appt) => (
            <div key={appt.id} className="border border-gray-100 dark:border-gray-800 rounded-xl p-3 hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
              <div className="flex justify-between items-start mb-2">
                <div className="font-semibold text-gray-900 dark:text-white line-clamp-1">{appt.providerName}</div>
              ...
              <div className="grid gap-1.5 text-xs">
                ...
                <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                  ...
                  <span>{appt.modality === 'ONLINE' ? 'Videoconsulta' : 'Presencial'}</span>
                </div>
              </div>
