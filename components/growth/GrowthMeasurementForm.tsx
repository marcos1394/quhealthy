        ...
        <div className="flex flex-col gap-2">
          ...
          <Popover>
              ...
              >
                ...
                {measurementDate ? (
                  <span className="text-black dark:text-white font-semibold">
                    {format(new Date(`${measurementDate}T12:00:00`), "dd MMM yyyy", { locale: es })}
                  </span>
                ) : (
            ...
            <PopoverContent className="z-[100] w-auto rounded-none border border-black dark:border-white p-0 bg-white dark:bg-[#0a0a0a]" align="start">
              <CalendarUI
                mode="single"
                selected={measurementDate ? new Date(`${measurementDate}T12:00:00`) : undefined}
                onSelect={(date) => setMeasurementDate(date ? format(date, "yyyy-MM-dd") : "")}
