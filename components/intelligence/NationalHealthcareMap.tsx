            ...
            <div className="p-0 min-w-[240px] max-w-[280px] bg-white border border-black shadow-[4px_4px_0_0_#000] overflow-hidden -m-1">
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="200"><rect width="100%" height="100%" fill="%23f3f4f6"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="monospace" font-size="10" font-weight="bold" fill="%239ca3af">VISUALIZACIÓN INACTIVA</text></svg>';
                  }}
                />
              ...
              <div className="p-4 bg-white text-black">
                ...
                <div className="text-[9px] font-bold uppercase tracking-widest text-gray-500 space-y-2 mb-6">
                  <p>
                    <span className="text-black">INSTITUCIÓN:</span>{" "}
                  ...
                  <p>
                    <span className="text-black">NIVEL:</span>{" "}
                    {selectedPoint.nivelAtencion}
                  </p>
                  <p>
                    <span className="text-black">ENTIDAD:</span>{" "}
