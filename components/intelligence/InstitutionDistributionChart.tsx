...
// Paleta de tonos esmeralda y teal del sistema de diseño
...
// Tooltip estilizado según el sistema de diseño Soft Health Tech
...
export function InstitutionDistributionChart() {
  const t = useTranslations("Intelligence.InstitutionDistributionChart");
  const {
    data: rawData,
    loading,
    error,
