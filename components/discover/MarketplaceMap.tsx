...
export const MarketplaceMap = () => {
  ...
  if (!isLoaded)
    return <div className="w-full h-full bg-gray-100 dark:bg-[#111]" />;
                      ...
                      <div className="min-w-[240px] max-w-[280px] font-sans -m-1 rounded-2xl overflow-hidden bg-white shadow-sm border border-gray-100">
                        ...
                        <div className="p-3 bg-white">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-1">
                                ...
                                {provider.reviews && provider.reviews > 0 ? (
                                  ...
                                  <span className="font-semibold text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full text-[10px]">
                                    Nuevo
                                  </span>
                                )}
                              </div>
                          ...
                          <Button
                            ...
                            style={{
                              backgroundColor: provider.color || "#0d9488",
                            }}
                          >
                            Ver Tienda
                          </Button>
                    ...
                    >
                      <div className="p-3 min-w-[220px] max-w-[260px] font-sans -m-1 rounded-xl bg-white shadow-sm border border-gray-100">
                        ...
                        <Button
                          ...
                          style={{
                            backgroundColor: item.providerColor || "#0d9488",
                          }}
                        >
                          Ver Detalles
                        </Button>
