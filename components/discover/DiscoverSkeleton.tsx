  ...
  return (
    <div
      className={cn(
        ...
        viewMode === "MAP"
          ? "flex overflow-x-auto overflow-y-hidden gap-3 pb-4 px-4 max-md:no-scrollbar md:flex-col md:flex-1 md:min-h-0 md:overflow-x-hidden md:overflow-y-scroll md:discover-cards-scrollbar md:gap-3 md:pb-8 md:px-0 md:pr-2"
