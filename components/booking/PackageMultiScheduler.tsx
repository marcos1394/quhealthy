      ...
      {saveAsCredit ? (
        <div className="p-8 md:p-12 text-center bg-gray-50 dark:bg-[#050505] flex flex-col items-center">
          ...
          <p className="text-[10px] uppercase tracking-widest text-gray-500 max-w-md mx-auto leading-relaxed">
            Esta sesión se agregará a tu cuenta tras el pago. Podrás agendarla
            cuando lo desees desde tu panel de paciente.
          </p>
        </div>
      ) : (
          ...
          <div className="flex-1 xl:max-w-md">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-0 border border-gray-300 dark:border-gray-700">
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center bg-white dark:bg-black hover:bg-gray-50 dark:hover:bg-[#111] disabled:opacity-30 border-r border-gray-300 dark:border-gray-700 transition-colors"
                >
                  <ChevronLeft
                    className="w-4 h-4 text-black dark:text-white"
                    strokeWidth={1.5}
                ...
                <button
                  onClick={nextMonth}
                  className="w-8 h-8 flex items-center justify-center bg-white dark:bg-black hover:bg-gray-50 dark:hover:bg-[#111] transition-colors"
                >
                  <ChevronRight
                    className="w-4 h-4 text-black dark:text-white"
                    strokeWidth={1.5}
            ...
            <div className="grid grid-cols-7 mb-2">
              {["Lun", "Mar", "Mié", "Jue", "Vie", "Sáb", "Dom"].map((d) => (
                <div
                  key={d}
                  className="text-center text-[9px] font-bold text-gray-500 uppercase tracking-widest"
                >
                  {d}
                </div>
              ))}
              ...
              isLoadingSlots ? (
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-0 border-t border-l border-gray-200 dark:border-gray-800">
                  {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div
                      key={i}
                      className="h-10 border-b border-r border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-900 animate-pulse"
                    />
                  ))}
                </div>
                ...
                <div className="py-10 flex flex-col items-center text-center border border-dashed border-gray-300 dark:border-gray-700 bg-white dark:bg-[#0a0a0a]">
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-widest text-black dark:text-white mb-1">
                    Sin horarios
                  </p>
