    ...
    <button
      ...
      className={cn(
        ...
        !isCurrentMonth || isPast
          ...
          : "cursor-pointer",
        selected ? "z-10" : "bg-gray-50 dark:bg-[#050505] border-transparent",
        !selected &&
          isCurrentMonth &&
          !isPast &&
          "hover:-translate-y-1 hover:shadow-[0_4px_20px_rgb(0,0,0,0.12)] hover:z-20 hover:[border-color:var(--provider-color)] hover:[color:var(--provider-color)]",
      )}
      style={
        {
          ...(selected
    ...
    >
      {today && !selected && (
        <span
          ...
          style={
            !selected && isCurrentMonth && !isPast
              ? { backgroundColor: safeColor }
              : {}
          }
        />
