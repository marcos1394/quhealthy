...
export function CourseCurriculumBuilder({ catalogItemId }: Props) {
  ...
  const handleVideoUpload = async (
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "No se pudo extraer/subir la miniatura automáticamente",
          err,
        );
      }
    } catch (error) {
  ...
  if (loading)
    return (
      <div className="text-sm p-4 animate-pulse">Cargando currículo...</div>
    );
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          variant="outline"
          className="h-8 rounded-none text-xs font-bold uppercase tracking-widest"
        >
      ...
      <div className="space-y-3">
        {modules.map((mod, mIndex) => (
          <div
            key={mod.id}
            className="border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#050505]"
          >
                ...
                >
                  <div className="p-4 pl-10 space-y-3">
                    {mod.lessons.map((lesson, lIndex) => (
                      <div
                        key={lesson.id}
                        className="flex flex-col sm:flex-row gap-4 p-3 border border-gray-100 dark:border-gray-900 items-start sm:items-center"
                      >
                    ...
                    <Button
                      ...
                      variant="ghost"
                      className="h-8 text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:text-black dark:hover:text-white mt-2 px-2"
                    >
      ...
      <ConfirmationModal
        ...
        title={
          deleteState.type === "module" ? "Eliminar Módulo" : "Eliminar Lección"
        }
        message={
          deleteState.type === "module"
