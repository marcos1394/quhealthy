        ...
        {!isBusinessPlan && staff.length === 0 && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p
                className="text-xs text-amber-800/80 dark:text-amber-300/80 font-light mb-6 leading-relaxed"
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="relative group/avatar mt-4">
                          <label
                            ...
                            className="cursor-pointer block w-full aspect-square border border-gray-300 dark:border-gray-700 bg-white dark:bg-black relative overflow-hidden group-hover/avatar:border-black dark:group-hover/avatar:border-white transition-colors"
                          >
                            {member.imageUrl ? (
                    ...
                    <div className="flex-1 p-6 md:p-8 space-y-6">
                      ...
                      <div className="space-y-2">
                        <Label className="text-[10px] font-bold uppercase tracking-widest text-black dark:text-white flex items-center justify-between">
                          {t("label_credentials")}
                          <span className="text-[9px] font-light text-gray-500 lowercase tracking-normal">
                            ({t("optional")})
                          </span>
                        </Label>
                        <Input
