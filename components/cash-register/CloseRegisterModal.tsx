          ...
          <div className="flex flex-col bg-gray-50 dark:bg-[#050505] overflow-y-auto max-h-[70vh] custom-scrollbar">
            ...
            {difference !== 0 && (
              <div className={cn(
                ...
                difference > 0 ? "bg-emerald-50 dark:bg-emerald-900/10 border-l-4 border-l-emerald-500" : "bg-red-50 dark:bg-red-900/10 border-l-4 border-l-red-500"
              )}>
                <AlertCircle className={cn("w-6 h-6 shrink-0 mt-1", difference > 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400")} strokeWidth={1.5} />
                <div>
                  <p className={cn("text-[9px] font-bold uppercase tracking-widest mb-1", difference > 0 ? "text-emerald-700 dark:text-emerald-400" : "text-red-700 dark:text-red-400")}>
                    {difference > 0 ? 'SOBRANTE DETECTADO' : 'FALTANTE DETECTADO'}
                  </p>
                  <p className={cn("text-2xl font-semibold tracking-tight", difference > 0 ? "text-emerald-800 dark:text-emerald-300" : "text-red-800 dark:text-red-300")}>
