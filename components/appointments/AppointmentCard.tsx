        ...
        <div className="p-6 lg:w-56 flex flex-col justify-center gap-2.5 border-t lg:border-t-0 lg:border-l border-gray-100 dark:border-gray-800 shrink-0">
          {canJoinVideo && (
            <Button
              ...
              className={cn(
                "w-full h-10 rounded-xl border-0 text-xs font-bold flex items-center justify-start pl-3.5 transition-all shadow-sm",
                isLateTolerance
          ...
          <Button
            ...
            className="w-full h-10 rounded-xl text-xs font-bold flex items-center justify-start pl-3.5 bg-white dark:bg-[#0a0a0a] text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 shadow-sm transition-all"
          >
          ...
          {(appt.status === "SCHEDULED" || appt.status === "PENDING_PAYMENT") &&
            !isPast && (
              <Button
                ...
                className="w-full h-10 rounded-xl text-xs font-bold flex items-center justify-start pl-3.5 bg-white dark:bg-[#0a0a0a] text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 shadow-sm transition-all"
              >
                <CalendarPlus className="w-4 h-4 mr-2 text-emerald-600 dark:text-emerald-400" strokeWidth={2} />
                <span>{t("btn_add_calendar")}</span>
              </Button>
            )}
          ...
          {(appt.status === "SCHEDULED" || appt.status === "PENDING_PAYMENT") &&
            !isPast && (
              <Button
                ...
                className="w-full h-10 rounded-xl text-xs font-bold flex items-center justify-start pl-3.5 bg-red-50/50 dark:bg-red-950/20 text-red-600 dark:text-red-400 border-red-200 dark:border-red-900/40 hover:bg-red-100 dark:hover:bg-red-900/50 transition-all shadow-sm"
              >
                <XCircle className="w-4 h-4 mr-2 text-red-500" strokeWidth={2} />
          ...
          {isPast && (
            <Button
              ...
              className="w-full h-10 rounded-xl text-xs font-bold flex items-center justify-start pl-3.5 bg-white dark:bg-[#0a0a0a] text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 shadow-sm transition-all"
            >
              <RefreshCw className="w-4 h-4 mr-2 text-emerald-600 dark:text-emerald-400" strokeWidth={2} />
              <span>{t("btn_rebook")}</span>
            </Button>
          )}
          ...
          {appt.status === "COMPLETED" && (
            <Button
              ...
              className="w-full h-10 rounded-xl text-xs font-bold flex items-center justify-start pl-3.5 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
            >
              <Download className="w-4 h-4 mr-2 text-emerald-600 dark:text-emerald-400" strokeWidth={2} />
              <span>{t("btn_receipt")}</span>
            </Button>
          )}
        </div>
      </div>
